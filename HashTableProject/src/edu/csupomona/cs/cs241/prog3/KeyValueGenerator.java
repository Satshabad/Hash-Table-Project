...
public class KeyValueGenerator {
     ...
     */
    private final int LENGTH_OF_STRING = 8;
    ...
    /**
     * This method get the next key in the sequence.
     * Every time this is called the key is increment by 1.
     * the key is in base 26. The max value of key is zzzzzzzz
     * 
     ...
     * @post a string with a value one more than the passed string will be returned (base 26)
     * @param nextKey the string to be incremented
     * @param pos the position to start the increment at
    ...
    private String nextKey(String nextKey, int pos) {
        ...
        // this make the new string, but since it's indexed in reverse it is made in reverse.
